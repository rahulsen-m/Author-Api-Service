...
namespace Library.API.Entities
{
    ...
    {
        public static void EnsureSeedDataForContext(IApplicationBuilder applicationBuilder){
                ...
                .CreateScope())
            {
                ...
                {
                    // Addd the seed data to the db
                    // Create list for the author
                    ...
                    new Author()
                    {
                        ...
                        Books = new List<Book>()
                        {
                            new Book()
                            {
                                ...
                                Title = "The Shining",
                                Description = "The Shining is a horror novel by American author Stephen King. Published in 1977, it is King's third       published novel and first hardback bestseller: the success of the book firmly established King as a     preeminent author   inthe horror genre. "
                            },
                            new Book()
                            {
                            ...
                            new Book()
                            {
                                ...
                                Title = "It",
                                Description = "It is a 1986 horror novel by American author Stephen King. The story follows the exploits of seven     children as they are terrorized by the eponymous being, which exploits the fears and phobias of its victims in  order     todisguise itself while hunting its prey. 'It' primarily appears in the form of a clown in order to   attract its    preferredprey of young children."
                            },
                            new Book()
                            {
                                Id = new Guid("60188a2b-2784-4fc4-8df8-8919ff838b0b"),
                                Title = "The Stand",
                                Description = "The Stand is a post-apocalyptic horror/fantasy novel by American author Stephen King. It expands    upon   thescenario of his earlier short story 'Night Surf' and outlines the total breakdown of society after the   accidental  releaseof a strain of influenza that had been modified for biological warfare causes an apocalyptic  pandemic which     kills off themajority of the world's human population."
                            }
                        }
                    },
                    new Author()
                    {
                        ...
                        Books = new List<Book>()
                        {
                            ...
                            new Book()
                            {
                                ...
                                Description = "A Dance with Dragons is the fifth of seven planned novels in the epic fantasy series A Song of Ice  and  Fireby American author George R. R. Martin."
                            }
                        }
                    },
                    new Author()
                    ...
                    new Author()
                    {
                        Id = new Guid("f731f76f-cccb-48c3-876e-e6429bf8ddbc"),
                        FirstName = "Rahul",
                        LastName = "Sen",
                        Genre = "Thriller",
                        DateOfBirth = new DateTimeOffset(new DateTime(1995, 10, 24)),
                        Books = new List<Book>()
                        {
                            new Book()
                            {
                                Id = new Guid("f2785405-f523-4c9c-a4c1-98ff27acebfe"),
                                Title = "Easy programming",
                                Description = "Duis ut veniam irure commodo mollit non aliquip commodo do. Labore eiusmod fugiat adipisicing ad cillum ut essealiqua officia non anim magna mollit. Dolore nulla officia qui et irure sit."
                            }
                        }
                    }
                };
